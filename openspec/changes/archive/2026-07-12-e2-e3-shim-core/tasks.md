...
- [x] 6.3 Shipped — PR #7 opened (branch `feat/e2-e3-shim-core`); `CLAUDE.md` state advanced to E6-next with the timer-throttling finding flagged. Merge gated on Calvin (`/merge`).
