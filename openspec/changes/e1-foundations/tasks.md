...
- [ ] 6.1 Run `/verify`-style end-to-end pass: fresh clone → build → scripts run → scenarios from all three specs hold; fix anything red
- [ ] 6.2 Ship via git-ship (PR-gated main); PR cites this change and the M0 exit criteria
